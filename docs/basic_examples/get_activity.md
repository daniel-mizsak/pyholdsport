...
To get a specific activity for a team, use the [`get_activity`](../reference/holdsport.md#pyholdsport.Holdsport.get_activity) method:

```py linenums="1"
--8<-- "docs_src/basic_examples/get_activity.py"
```
